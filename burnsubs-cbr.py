...
class burnsubs(srt2ass):
    def __init__(self,source, font, fontsize, marginv, resX, resY, in_video, out_video,cbr,bold):
    ...
    def burn(self):
        ...
        ffmpeg.concat(video.filter("subtitles", self.assname), audio, v=1, a=1)\
            .output(self.out_video,acodec='libfdk_aac' ,ab = '96K', b=self.cbr, maxrate = self.cbr,minrate = self.cbr).run()
# resX = '1920'
# resY = '1080'
# source = 'id.srt'
# font = '微软雅黑'
